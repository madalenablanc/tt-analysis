...
# Open the ROOT file
file = ROOT.TFile("/eos/cms/store/user/jjhollar/TauTau_NanoAOD_Madalena/BackgroundSamples/TauhTauh/ttJets_2018_UL_skimmed_TauTau_nano_fase1total-protons_2018.root", "READ")
...
hist = ROOT.TH1F("h1", "Variable Title;X-axis;Y-axis", 100, 0, 100)  # Adjust bins and range
