...
TLorentzVector tau0, tau1, nu;
 ...
 TFile fundo ("/eos/cms/store/user/jjhollar/TauTau_NanoAOD_Madalena/SignalSamples/TauhTauh/GammaGammaTauTau_2018_UL_TauTau_SMandBSMweights_ntuplesfrommini.root");
