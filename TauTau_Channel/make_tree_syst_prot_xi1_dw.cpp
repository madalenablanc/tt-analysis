...
int main() {
    ...
    TFile* outputFile = TFile::Open("TauTau_sinal_PIC_march_2018_xi1_dw_syst.root", "RECREATE");
    if (!outputFile) {
    ...
    Double_t xi_arm1_1;
    Double_t xi_arm1_1_down;

    // Criar os apontadores para as folhas do inputTree
    TBranch* b_xi_arm1_1 = nullptr;
    TBranch* b_xi_arm1_1_down = nullptr;

    // Associar os apontadores às folhas do inputTree
    inputTree->SetBranchAddress("xi_arm1_1", &xi_arm1_1, &b_xi_arm1_1);
    inputTree->SetBranchAddress("xi_arm1_1_down", &xi_arm1_1_down, &b_xi_arm1_1_down);
