...
int main() {
   ...
   TFile *outputFile = new TFile("/eos/user/m/mpisano/tautau/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/Informacao_BDT_2018tautau_scalar_400.root", "RECREATE");
   ...
   hist1 -> Scale(30.5/hist1 -> Integral());
