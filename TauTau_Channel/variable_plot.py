...
# Open the ROOT file
file = ROOT.TFile("/eos/cms/store/user/jjhollar/TauTau_NanoAOD_Madalena/BackgroundSamples/TauhTauh/QCD_2018_UL_skimmed_TauTau_nano_fase1total-protons_2018.root ", "READ")
...
hist = ROOT.TH1F("h1", "Variable Title;X-axis;Y-axis", 100, -2, 2)  # Adjust bins and range

# Fill histogram from tree variable
tree.Draw("sist_rap>>h1")  # Replace 'variable_name' with your variable
...
# Save the plot
canvas.SaveAs("rap_qcd_original.png")  # Can also use .pdf, .eps, .svg, etc.
