...
TFile fundo ("/eos/user/m/mpisano/analyser/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/Data_TauPairTriggers_2018_UL_sgn_BSM_scalar_M800_NWA_nov23.root");

TTree* ntp1 = (TTree*) fundo.Get("ntp1");

TFile output ("./TauTau_sinal_PIC_scalar_800_NWA_nov_2018.root", "RECREATE", "");
