...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 TFile fundo ("/eos/user/m/mpisano/analyzer_mutau/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/MuTau_2018_SM_july.root");
...
for (int i = 0; i < ntp1 -> GetEntries(); i++){
	...
	ntp1 -> SetBranchAddress ("bsm_weights", &bsm_weights, &bsm_weightsB);
        ...
        weight_sample = 54900.*((*weight_sm)[0])/(4000.*1000.);
