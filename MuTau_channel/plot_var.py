...
x_min = 0                         # X-axis min
x_max = 10           # X-axis max
output_plot = "nproton_multi_data_no_requirements.png"    # Output image file
...
def plot_n_protons(file_mc,file_data,tree_name,bins,x_min,x_max,variable_mc,variable_data):
    ...
    # Create data histogram (will be drawn as points)
...
input_data="/eos/user/m/mblancco/tau_analysis/MuTau_channel/Data_merge_2018_UL.root"
plot_n_protons(input_mc,input_data,"tree",10,0,10,"n_pu","nproton_multi")
