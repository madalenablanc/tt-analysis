...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 TFile fundo ("/eos/user/m/mpisano/analyzer_mutau/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/Data_MuTauTriggers_2018C_BSM_scalar_1000_NWA_nov.root");
 TTree* ntp1 = (TTree*) fundo.Get("ntp1");
 TFile output ("./MuTau_sinal_BSM_2018_scalar_m1000_NWA.root", "RECREATE", "");
