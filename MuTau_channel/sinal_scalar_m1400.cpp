...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 ntp1->Add("/eos/user/j/jjhollar/TauTauBackup/analyzer_mutau/CMSSW_12_5_0/test/scalar_1400/Data_MuTauTriggers_2018C_BSM_scalar_1400_nov_*.root");
 TFile output ("./scalars/MuTau_sinal_BSM_2018_scalar_m1400.root", "RECREATE", "");
...
c1.SaveAs("./scalars/histo_e_pt_scalar_m1400.png");

TCanvas c2;
histo_tau_pt.Draw("histo");
c2.SaveAs("./scalars/histo_tau_pt_scalar_m1400.png");

TCanvas c3;
histo_n_tau.Draw("histo");
c3.SaveAs("./scalars/histo_n_tau_scalar_m1400.png");

TCanvas c4;
histo_n_eletron.Draw("histo");
c4.SaveAs("./scalars/histo_n_eletron_scalar_m1400.png");

TCanvas c5;
histo_acop.Draw("histo");
c5.SaveAs("./scalars/histo_acop_scalar_m1400.png");

TCanvas c6;
histo_Pt.Draw("histo");
c6.SaveAs("./scalars/histo_Pt_scalar_m1400.png");

TCanvas c7;
histo_Mt.Draw("histo");
c7.SaveAs("./scalars/histo_Mt_scalar_m1400.png");

TCanvas c8;
histo_DR.Draw("histo");
c8.SaveAs("./scalars/histo_DR_scalar_m1400.png");
