#!/usr/bin/env python3
"""
Phase 2 QCD: Apply proton requirements
...
overwrite     = True
prefix        = "/eos/user/m/mblancco/samples_2018_mutau/fase1_qcd_proton_vars/"

print("Processing QCD - Phase 2 (PPS Selection)\n")
...
print("\nPhase 2 QCD (PPS selection) completed for requested files.")