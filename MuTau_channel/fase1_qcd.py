...
output_prefix = "/eos/user/m/mblancco/samples_2018_mutau/fase1_qcd_proton_vars/QCD_2018_UL_skimmed_MuTau_cuts_"
    ...
    try:
        ...
        df_filtered = (
            ...
            #   .Filter("HLT_IsoMu24 == 1", "HLT single-muon 2018")
              ...
              .Filter("tau_id3  > 1",  "Tau VSmuon")
              .Filter("muon_pt > 35. && tau_pt > 100.", "pT thresholds")
              .Filter("muon_charge * tau_charge > 0", "Same sign")
