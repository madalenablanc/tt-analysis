...
int main(){
	...
	string prefix_output = "ttjets_2018_UL_skimmed_MuTau_nano_not_parellel_";
	...
	string output_tot = "/eos/user/m/mblancco/samples_2018_mutau/" + prefix_output + out_put + ".root";	//ficheiro onde vão ficar guardadas as variáveis. localização implícita
