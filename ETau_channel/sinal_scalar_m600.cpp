...
xi_sist_2->Fit("xi_sist_inter_2");
 ...
 TFile fundo ("/eos/user/m/mpisano/analyzer_etau/CMSSW_12_5_0/src/ExclTauTau/ExclTauTau/test/Data_ETauTriggers_2018_UL_BSM_scalar_600_NWA_nov.root");
 TTree* ntp1 = (TTree*) fundo.Get("ntp1");
 TFile output ("./ETau_sinal_BSM_scalar_m600_NWA_nov.root", "RECREATE", "");
