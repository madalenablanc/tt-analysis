...

{
   ...
   TString fnameBKG = "/eos/user/m/mpisano/samples_2018_etau/fase1_etau/suma_fundos_fase1/allBkg_total-protons_syst.root";

   TString fnameSIGN = "ETau_sinal_SM_july.root";
   ...
   TString outfileName( "Output_TMVA_bsm.root");
  ...
  dataloader->AddVariable( "e_pt", "eletron pt", "GeV",'F');
...
//  #################################################################################################################################
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                           ...
                                           "nTrain_Signal=5000:nTrain_Background=8500:SplitMode=Random:NormMode=NumEvents:!V" );
