...
int main(){
  ...
  //string prefix = "root:://cms-xrd-global.cern.ch//";
	...
	string prefix_output = "GammaGammaTauTau_SignalMC_SM_18UL_23k_NANOAODSIM_fase1_with_xi_mctry_code";
	...
	TFile *f = TFile::Open("/eos/user/m/mblancco/samples_2018_tautau/fase0_2/ttJetscode_GammaGammaTauTau_SignalMC_SM_18UL_23k_NANOAODSIM_fase0_with_xi_.root");
	...
	out.Branch("proton_xi_multi_rp", &entry_31, "proton_xi_multi_rp/D");
        ...
        if(deltaphi>M_PI)
    {
        ...
        // entry_31=tree->GetLeaf("Proton_multiRP_xi")->GetValue(0);

        if (tree->GetLeaf("proton_xi_multi_rp") != nullptr) {
            entry_31 = tree->GetLeaf("proton_xi_multi_rp")->GetValue(0);
        } else {
            cout << "Leaf proton_xi_multi_rp not found!" << endl;
            entry_31 = -999; // Default or placeholder value
        }
