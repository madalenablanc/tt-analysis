...
int main(){
  ...
  //string prefix = "root:://cms-xrd-global.cern.ch//";
	...
	string output_tot = "/eos/user/m/mblancco/samples_2018_tautau/fase1_2/" + prefix_output + ".root";
	...
	int entry_29;
    double proton_xi1, proton_xi2, p_rapidity, p_invariant_mass, delta_phi;
	//contadore
	int nid=0;
	int ncharge=0;
	int npt=0;
    ...
    out.Branch("delta_phi", &delta_phi, "delta_phi/D");
...
//
            ...
            p_invariant_mass=tree->GetLeaf("p_invariant_mass")->GetValue();
            p_rapidity=tree->GetLeaf("p_rapidity")->GetValue();
